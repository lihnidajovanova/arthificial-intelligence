...
Потребно е да ги нормализирате податоците со MinMaxScaler со ранг (-1,1). Потоа треба да изградите невронска мрежа која
...
## Задачи за вежбање за втор колоквиум - 13
