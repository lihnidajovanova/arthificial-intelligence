...
if __name__ == "__main__":
    ...
    hanoi_tower = HanoiTower(initial_towers, goal_towers)
    result = breadth_first_graph_search(hanoi_tower)
    answer = result.solution()
    print(f"Number of action {len(answer)}")
    print(answer)
