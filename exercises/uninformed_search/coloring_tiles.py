...
class ColoringTiles(Problem):
    ...
    def goal_test(self, state):
        return sum([i for row in state for i in row]) == self.n ** 2
...
if __name__ == "__main__":
    ...
    coloring_tiles = ColoringTiles(n, tuple(initial_state))

    result = breadth_first_graph_search(coloring_tiles)
