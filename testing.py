...
def train_test_split(dataset, cf, x1, x2):
    ...
    test_set = set_0[idx(set_0, x2):] + set_1[idx(set_1, x2):] + set_2[idx(set_2, x2):]
    train_set = []
    if cf == "NB":
        train_set = set_0[:idx(set_0, x1)] + set_1[:idx(set_1, x1)] + set_2[:idx(set_2, x1)]
    elif cf == "DT":
        train_set = set_0[idx(set_0, x1):idx(set_0, x2)] + set_1[idx(set_1, x1):idx(set_1, x2)] + set_2[
                                                                                                  idx(set_2, x1):idx(
                                                                                                      set_2, x2)]
    else:
